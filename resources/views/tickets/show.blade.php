        ...
        <div style="max-width: 960px; margin: 0 auto; padding: 0 24px;">
                ...
                <div style="padding: 24px;">
                    ...
                    @if(Auth::user()->role === 'admin' || Auth::user()->role === 'agent')
                        <div style="border-top: 1px solid #e2e8f0; padding-top: 20px;">
                            <h3 style="font-size: 14px; font-weight: 600; color: #374151; margin: 0 0 12px 0;">Actualizar Ticket</h3>
            ...
            <div style="display: flex; justify-content: space-between; margin-top: 24px;">
                <a href="{{ route('tickets.index') }}"
                   style="background-color: #e5e7eb; color: #374151; padding: 10px 18px; border-radius: 6px; text-decoration: none; font-size: 14px; font-weight: 500;">
                    Volver a la lista
                </a>
            </div>
